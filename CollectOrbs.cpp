...
void DrawButton(Rectangle background, Color backgroundC, Color Outline, int OutlineThickness, string ButtonText, Vector2 posT, int fontS, Color TColor)
{
    ...
    DrawText(ButtonText.c_str(), posT.x, posT.y, fontS, TColor); // text
}
...
void credits()
{
    ...
    DrawText("SFX Credits:\nPixabay", 285, 180, 32, WHITE);
}
...
void menu(Sound buttonhover)
{
    ...
    DrawText("version 1.2.1", 320, 100, 25, WHITE); // version
